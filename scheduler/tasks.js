export const TASKS = [
  ...
  // ── note（週3回：月・水・金に生成、火・木・土に投稿） ──────────────
  // Instagram account2（アフィリエイト）月・水・金投稿に連動した流入強化
  {
    name: 'note:research',
    cron: '0 8 * * 1,3,5',         // 月・水・金 08:00 — スクレイプ → テーマ生成
  },
  {
    name: 'note:generate',
    cron: '0 10 * * 1,3,5',        // 月・水・金 10:00 — 記事生成（research後にバッファ確保）
  },
  {
    name: 'note:image',
    cron: '0 11 * * 1,3,5',        // 月・水・金 11:00 — 画像生成
  },
  {
    name: 'note:post',
    cron: '0 10 * * 2,4,6',        // 火・木・土 10:00 — DEV: 下書き保存 / PROD: 自動公開
  },
  ...
  // ── 流入導線（note投稿の15分後にX告知・週3回） ───────────────────
  {
    name: 'x:note-promo',
    cron: '15 10 * * 2,4,6',       // 火・木・土 10:15 — note公開後にX告知
  },
