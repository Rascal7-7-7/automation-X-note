...
const SHORT_BUZZ_TEMPLATES = [
  { id: 1, name: 'AIデモ型',  hook: 'これ全部AIで作ってます',   cta: 'どうやって作ったと思う？' },
  { id: 2, name: 'AI比較型',  hook: 'AIと現実、どっちかわかる？', cta: '正解はコメントで教えて' },
  { id: 3, name: 'AI裏側型',  hook: 'プロンプトはこれだけです',  cta: '試してみた？コメントで' },
  { id: 4, name: 'AI進化型',  hook: '去年のAIと今のAIが別物です', cta: 'どっちが好き？コメントで' },
  { id: 5, name: 'AIループ型', hook: 'AIが作った世界を見てください', cta: '気づいた？もう一回見て' },
];
...
- 「実は[ツール名]を使ってます」をscript[2]に入れること

【絶対ルール】
- JSONのみ出力（説明・マークダウン不要）
- hookText: 0秒テロップ（12文字以内・AI暴露型断定フック）
- script: 6要素の配列（1要素=1文、最大18文字、絵文字・記号禁止）
- script[2]に必ずAIツール名 or 技術情報を入れる（価値提供）
- script[4]は必ず崩壊/ループのどちらか
...
【必須6フェーズ構成】
[HOOK 0:00〜0:05] 「この映像、全部AIです」— AI暴露型フック。結論を先に言う
[PHASE 1 〜0:30] 普通に見せる — ぱっと見は現実と区別つかない映像。違和感を仕込む
[PHASE 2 〜1:00] AI価値提供 — 「実はこのAIを使ってます」ツール名 + 使い方を軽く解説
[PHASE 3 〜3:00] どう作ったか — 生成過程を軽く見せる。異常を強化していく
[PHASE 4 〜8:00] 崩壊/完成形 — AIが作った世界の完成 → 崩壊 or ループ + 伏線回収
[OUTRO 〜10:00] 「気づいた？何個わかった？コメントで教えて」+ チャンネル登録CTA

【各フェーズのルール】
- HOOK: 「この動画は[AIツール名]で作りました」を1文目に
- PHASE2: 必ず具体的AIツール名と簡単な説明を入れる（視聴者の学び）
- PHASE3: 「このシーン、実は[技術的説明]」形式で裏側を見せる
- PHASE4: 完成形を見せてから崩壊/ループ。「最初から見ると全部繋がります」
- OUTRO: ループ誘導必須 + コメント誘導 + フォロー促進
